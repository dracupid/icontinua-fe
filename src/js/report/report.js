 ...
 * 单次报告详情页面
 */
import HeightWeight from './single/HeightWeight'
import Blood from './single/Blood'
import O2 from './single/O2'
import Bloods from './single/Bloods'
import ElseBlock from './single/else'
import Chinese from './single/Chinese'
import Loading from '../Components/Loading'
import Banner from '../Components/Banner'
import {setReport} from './../wechat'
